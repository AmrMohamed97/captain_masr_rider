...
class RacingSendRequestSuccessAlertDialog extends StatefulWidget {
  const RacingSendRequestSuccessAlertDialog({
    super.key,
  });

  @override
  State<RacingSendRequestSuccessAlertDialog> createState() =>
      _RacingSendRequestSuccessAlertDialogState();
}

class _RacingSendRequestSuccessAlertDialogState
    extends State<RacingSendRequestSuccessAlertDialog> {
  @override
  void initState() {
    super.initState();
    Future.delayed(
