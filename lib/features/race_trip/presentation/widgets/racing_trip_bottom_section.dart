...
import 'package:captain_masr_rider/features/race_trip/presentation/widgets/racing_trip_choose_start_and_end_locations.dart';
...
import 'racing_ride_promo_code_alert_dialog.dart';

class RacingTripBottomSection extends StatelessWidget {
  const RacingTripBottomSection({super.key});
                              ...
                              onTap: () {
                                if (cubit.promoCodeModel == null) {
                                  showModalBottomSheet(
                                    ...
                                    builder: (context) =>
                                        const RacingRidePromoCodeAlertDialog(),
                                  ).then((value) {
                                    cubit.promoCodeController.text =
                                        (value as PromoCodeModel?)?.name ?? "";
                                    ...
                                    prefixIcon: Column(
                                      ...
                                      children: [
                                        CustomSvgPicture(
                                          ...
                                          color: cubit.promoCodeModel != null
                                              ? AppColors.primary
                                              : AppColors.greyText,
                                        ),
                                      ],
                                  ...
                                  ? navigate(
                                      ...
                                      then: (value) {
                                        if (value != null && value is List) {
                                          cubit.mainPaymentMethodId = value[0];
                                          cubit.subPaymentMethodId = value[1];
                                          // if (cubit.isDelivery) {
