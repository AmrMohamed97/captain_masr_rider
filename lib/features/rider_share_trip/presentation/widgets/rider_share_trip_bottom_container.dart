...
import '../views/rider_share_trip_view.dart';

class RiderShareTripBottomContainer extends StatelessWidget {
  final int tripId;
  const RiderShareTripBottomContainer({super.key, required this.tripId});
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<RiderShareTripCubit, RiderShareTripState>(
                                    ...
                                    ChatView(
                                      chatId: getChatId(
                                          ...
                                          riderId: cubit.tripDetails!
                                              .riderId!), //cubit.tripDetails!.id ?? 0,
                                      senderId: cubit.tripDetails!.riderId ?? 0,
                                      receiverId:
                                          cubit.tripDetails!.driverId ?? 0,
                                      senderName:
                            ...
                            children: [
                              ...
                              cubit.isTripStarted
                                  ...
                                  : cubit.isDriverWaiting
                                      ? UpTimeTimer(
                                          arrivedTime: cubit
                                                      .tripDetails!.arrivedAt !=
                                                  null
                                              ? DateTime.parse(
                                                      "${cubit.tripDetails!.arrivedAt!}Z")
                                                  .toLocal()
                                              : DateTime.now(),
                                        )
