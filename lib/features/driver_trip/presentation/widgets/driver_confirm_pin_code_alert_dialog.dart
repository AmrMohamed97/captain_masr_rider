...
class DriverConfirmPinCodeAlertDialog extends StatefulWidget {
  const DriverConfirmPinCodeAlertDialog({
    super.key,
    required this.code,
  });
  ...
  @override
  State<DriverConfirmPinCodeAlertDialog> createState() =>
      _DriverConfirmPinCodeAlertDialogState();
}

class _DriverConfirmPinCodeAlertDialogState
    extends State<DriverConfirmPinCodeAlertDialog> {
