...
class OnMyWayArrivedAlertDialog extends StatefulWidget {
  const OnMyWayArrivedAlertDialog({super.key});

  @override
  State<OnMyWayArrivedAlertDialog> createState() =>
      _OnMyWayArrivedAlertDialogState();
}

class _OnMyWayArrivedAlertDialogState extends State<OnMyWayArrivedAlertDialog> {
  @override
  void initState() {
    super.initState();
    Future.delayed(
