...
class DownTimeTimerShare extends StatefulWidget {
  final num timeMinutes;

  const DownTimeTimerShare({super.key, required this.timeMinutes});

  @override
  State<DownTimeTimerShare> createState() => _DownTimeTimerShareState();
}

class _DownTimeTimerShareState extends State<DownTimeTimerShare> {
  Timer? _timer;
  ...
  @override
  void didUpdateWidget(covariant DownTimeTimerShare oldWidget) {
