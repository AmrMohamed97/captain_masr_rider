...
class DriverShareTripCompletedAlertDialog extends StatelessWidget {
  const DriverShareTripCompletedAlertDialog({
    super.key,
    required this.model,
    this.completedTripsToday,
    this.isDeliveryTrip = false,
    this.continueTrip = true,
    required this.completeTripResponseModel,
  });
